...
-- -----------------------------------------------------
-- Table `farmacia`.`telefones_cliente`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `farmacia`.`telefones_cliente` ;

CREATE TABLE IF NOT EXISTS `farmacia`.`telefones_cliente` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `telefone` VARCHAR(20) NOT NULL,
  `id_cliente` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_telefones_cliente_idx` (`id_cliente` ASC),
  CONSTRAINT `fk_telefones_cliente_1`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos_compra` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_compra_idx` (`id_compra` ASC),
...
CREATE TABLE IF NOT EXISTS `farmacia`.`receitas_medica` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_receitas_medica_idx` (`id_produto_compra` ASC),
